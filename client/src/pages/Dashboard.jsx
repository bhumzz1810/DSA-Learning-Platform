      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <h2
              className={`text-xl sm:text-2xl font-bold ${currentTheme.title}`}
            >
              🔥 Daily Challenge
            </h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <h3
                    className={`text-lg font-semibold ${currentTheme.title} mb-1`}
                  >
                    {dailyChallenge.title}
                  </h3>
                  <p
                    className={`text-sm ${currentTheme.subtitle} line-clamp-2`}
                  >
                    {dailyChallenge.description}
                  </p>
                </div>
                <span
                  className={`px-2 py-1 text-xs font-semibold rounded-full min-w-[70px] text-center ${
