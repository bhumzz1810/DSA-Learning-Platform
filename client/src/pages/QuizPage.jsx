...
const QuizPage = () => {
  ...
  const remaining = isSubscribed ? "Unlimited" : Math.max(FREE_LIMIT - attempted, 0);

  const subscriptionModal = (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md text-center animate-fadeIn">
        <h2 className="text-3xl font-extrabold text-blue-700 mb-4">🚫 Free Limit Reached</h2>
        ...
        <>
          ...
          {showExplanation && (
            <>
              ...
              >
                Next Question
                {isFetchingNext && <span className="ml-2 inline-block animate-spin">⏳</span>}
              </button>
            </>
          )}
        </>
