...
const CodingRoom = () => {
  ...
  useEffect(() => {
    ...
    const onUsersUpdated = (updatedUsers) => setUsers(updatedUsers);
      ...
      <header className={`p-4 flex justify-between items-center border-b ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
        <div>
          ...
          <p className="text-sm">
            ...
            {roomId && <span className="ml-2">Room: {roomId}</span>}
          </p>
        </div>
        <div className="flex space-x-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded transition-colors ${
              !activeFile || isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-green-600 hover:bg-green-700'
            } text-white`}
          >
          ...
          <button
            ...
            disabled={!activeFile || isLoading}
            className={`px-4 py-2 rounded transition-colors ${
              !activeFile || isLoading ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'
            } text-white`}
          >
            Download
          </button>
