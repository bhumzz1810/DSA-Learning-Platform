...
const Contact = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setNote({ ok: true, text: data.message || "Message sent!" });
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <form className="space-y-6 text-left" onSubmit={onSubmit}>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-cyan-500 text-white font-medium py-3 rounded-full hover:bg-cyan-600 transition disabled:opacity-60 disabled:cursor-not-allowed"
          >
