  ...
  return (
    <div className={`rounded-xl p-6 space-y-6 relative ${currentTheme.bg}`}>
      ...
      <div className={`p-4 rounded-md text-center ${currentTheme.cardBg}`}>
        <p className={`text-sm ${currentTheme.highlight}`}>XP Earned (Today)</p>
        <p className={`text-2xl font-bold ${currentTheme.text}`}>{user.xp}XP</p>
      </div>

      <div className="grid grid-cols-2 gap-4">
        <div className={`p-4 rounded-md text-center ${currentTheme.cardBg}`}>
          <p className={`text-sm ${currentTheme.highlight}`}>Current Rank</p>
          <p className={`text-xl font-bold ${currentTheme.text}`}>
            #{userRank}
          </p>
        </div>
        <div className={`p-4 rounded-md text-center ${currentTheme.cardBg}`}>
          <p className={`text-sm ${currentTheme.highlight}`}>Current Level</p>
          <p className={`text-xl font-bold ${currentTheme.text}`}>
            {user.level}
          </p>
        </div>
      ...
      <div className={`p-4 rounded-md text-center ${currentTheme.cardBg}`}>
        <p className={`text-sm ${currentTheme.highlight}`}>Total XP Earned</p>
        <p className={`text-xl font-bold ${currentTheme.text}`}>{user.xp}XP</p>
      </div>
